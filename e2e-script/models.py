...
class myUnetHP(object):
    def build(self, n_depth_layers, n_init_filters, IMG_HEIGHT=256, IMG_WIDTH=256, IMG_CHANNELS=3, verbose=1, initializer=glorot_normal, x_max=1., dropouts_frac=None):
